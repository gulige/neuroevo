...
-define(INIT_CONSTRAINTS,[#constraint{morphology=Morphology,connection_architecture=CA, population_evo_alg_f=generational, neural_pfns=[hebbian]} || Morphology<-[discrete_tmaze],CA<-[recurrent]]).
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		E ->
			case E#experiment.progress_flag of
				...
				in_progress ->
					...
					U_Interruptions = [util:now()|Interruptions],
					U_E = E#experiment{
