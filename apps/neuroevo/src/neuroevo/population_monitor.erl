...
-define(INIT_CONSTRAINTS,[#constraint{morphology=Morphology,connection_architecture=CA, population_evo_alg_f=steady_state,agent_encoding_types=[neural],substrate_plasticities=[iterative],substrate_linkforms = [l2l_feedforward]} || Morphology<-[prey,predator],CA<-[recurrent]]).
-record(state,{
	op_mode = gt,
	population_id = test,
	activeAgent_IdPs = [],
